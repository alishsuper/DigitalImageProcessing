...
# zero padding
img = np.pad(img, ((256, 256), (256, 256)), 'constant')
...
# croping images
crop_img_back = img_back[256:768, 256:768]

crop_img_back_out = img_back_out[256:768, 256:768]
...
plt.title('IDFT outside zero, smoothing, LPF'), plt.xticks([]), plt.yticks([])
